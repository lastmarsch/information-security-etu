    ...
    for cve_item in cve_data['CVE_Items']:   
        ...
        for node in cve_item['configurations']['nodes']:
            for cpe_match in node['cpe_match']:
                ...
                print(f'{version_start_excluding} {version_start_including} {version_end_excluding} {version_end_including}')
                for software_CPE in cpe_software_list:
                    ...
                    if is_version_after_start and is_version_before_end:
                        print(f'is_version_after_start {is_version_after_start} : is_version_before_end {is_version_before_end}')
                    
                    if software['cpe_name'] == cpe_uri or is_version_after_start and is_version_before_end:                        
